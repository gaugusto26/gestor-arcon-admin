...
(4, 2, 'E-mail enviado: Bem-vindo à Digital Five!', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36', '2026-02-21 17:56:23'),
...
CREATE TABLE `newsletter_config` (
  `id` int(11) NOT NULL,
  `remetente_nome` varchar(100) DEFAULT 'Digital Five',
...
(1, 'Digital Five', 'sistemasntw@gmail.com', 30, 500, 'smtp.gmail.com', 587, 'sistemasntw@gmail.com', 'dcvj lezc qwoc yvim', 'tls', '', '', 'logo.png', '', 'https://instagram.com/arcon.digitalfive', '5519987111656', '2026-02-20 20:58:16', '2026-02-22 15:11:46');
