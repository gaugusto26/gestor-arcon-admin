...
<div class="main-content" id="mainContent">
    ...
    <div class="content-area">
        ...
        <div class="termos-info">
            <div class="termos-avatar">
                <i class="fas fa-shield-alt"></i>
            </div>
            <div class="termos-details">
                <h3><?php echo $termos['titulo']; ?></h3>
                <div class="termos-meta">
                    <span><i class="fas fa-code-branch"></i> Versão <?php echo $termos['versao']; ?></span>
                    <span><i class="fas fa-calendar"></i> Criada em <?php echo date('d/m/Y H:i', strtotime($termos['created_at'])); ?></span>
                    <span>
                        <i class="fas fa-tag"></i> 
                        <span class="termos-status status-<?php echo $termos['status']; ?>">
                            <?php echo ucfirst($termos['status']); ?>
                        </span>
                    </span>
                </div>
            </div>
            <a href="visualizar.php?id=<?php echo $termos['id']; ?>" class="btn btn-secondary">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    ...
                    <div style="margin-top: 15px; display: flex; gap: 10px; justify-content: flex-end;">
                        <a href="restaurar.php?id=<?php echo $termos['id']; ?>&versao=<?php echo $item['versao']; ?>" class="btn-icon" onclick="return confirm('Restaurar esta versão? Isso criará uma nova versão baseada neste conteúdo.')">
