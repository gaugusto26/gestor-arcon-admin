...
$versoes = $conn->query("
    SELECT p.*, a.nome_completo as autor_nome,
           (SELECT COUNT(*) FROM politica_secoes WHERE politica_id = p.id) as total_secoes
...
$politica_ativa = getPoliticaAtiva();
?>
...
<div class="main-content" id="mainContent">
    <div class="top-bar">
        <h1 class="page-title">
            <i class="fas fa-shield-alt" style="color: #4361ee; margin-right: 10px;"></i>
    ...
    <div class="content-area">
        <!-- Banner da Política Ativa -->
        <?php if($politica_ativa): ?>
        <div class="active-banner">
            <div class="active-icon">
                <i class="fas fa-check-circle"></i>
            </div>
            <div class="active-info">
                <h3>Política em Vigor</h3>
                <p><strong><?php echo $politica_ativa['titulo']; ?></strong> - Versão <?php echo $politica_ativa['versao']; ?></p>
                <span class="active-badge">PUBLICADA EM <?php echo date('d/m/Y', strtotime($politica_ativa['data_publicacao'])); ?></span>
            </div>
            <div class="active-actions">
                <a href="editar.php?id=<?php echo $politica_ativa['id']; ?>" class="btn btn-secondary">
                    <i class="fas fa-edit"></i> Editar
                </a>
                <a href="visualizar.php?id=<?php echo $politica_ativa['id']; ?>" class="btn btn-primary">
        ...
        <div class="versoes-grid">
            ...
            <div class="empty-state">
                ...
                <a href="criar.php" class="btn btn-primary">
                    <i class="fas fa-plus"></i> Criar Política
                </a>
            </div>
            <?php else: ?>
                ...
                <div class="versao-card <?php echo $card_class; ?>">
                    ...
                    <div class="versao-footer">
                        ...
                        <?php endif; ?>
                        <?php if($versao['status'] == 'publicado' && $versao['id'] != $politica_ativa['id']): ?>
